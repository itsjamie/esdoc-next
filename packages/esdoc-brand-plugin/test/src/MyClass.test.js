...
describe('test/MyClass.js:', ()=> {
  ...
  it('has brand title', ()=>{
    assert.equal($('title').text(), 'Home | @itsjamie/esdoc-brand-plugin-test');
  });
  ...
  it('has meta tag', ()=>{
    ...
    assert.equal($('meta[property="og:site_name"]').attr('content'), '@itsjamie/esdoc-brand-plugin-test');
    assert.equal($('meta[property="og:title"]').attr('content'), '@itsjamie/esdoc-brand-plugin-test');
    ...
    assert.equal($('meta[property="twitter:title"]').attr('content'), '@itsjamie/esdoc-brand-plugin-test');
